...
| 模式名稱 | 應用位置 | 核心價值 |
|----------|----------|----------|
| **Time-boxing Pattern** | 30秒限制 | 用時間壓力繞過內在審查 |
| **Sprint Pattern** | 高強度短爆發 | 集中能量，快速迭代 |
| **Quantity Over Quality** | 產出原則 | 先求量，再篩選質 |
| **Relay Pattern** | 傳遞機制 | 想法在傳遞中進化成長 |

**核心洞察**：Ideation Relay Race 利用了「沒時間思考」這件看似負面的事。30 秒內，你的內在編輯器來不及啟動：「這想法夠好嗎？」「別人會怎麼看？」「這可行嗎？」這些問題都需要時間，而你沒有時間。這不是缺點，這是設計。最瘋狂的想法往往在第一秒出現，然後被我們的「理性」扼殺。時間壓力讓那些想法在被扼殺前就已經寫在紙上了。Crazy 8s 的創造者 Jake Knapp 說得好：「沒有壞想法，只有第一版。」
