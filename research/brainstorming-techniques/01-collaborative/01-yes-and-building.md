...
```mermaid
flowchart LR
    A[想法 A] -->|"Yes, and..."| B[想法 A+B]
    B -->|"Yes, and..."| C[想法 A+B+C]
    C -->|"Yes, and..."| D[複合創新想法]
...
sequenceDiagram
    ...
    participant P1 as 參與者A
    participant P2 as 參與者B
    participant P3 as 參與者C
...
| 模式名稱 | 應用位置 | 核心價值 |
|----------|----------|----------|
| **Psychological Safety** | 全程 | 創造無批判環境，讓人敢於表達 |
| **Divergent-Convergent Pattern** | Yes=發散，評估=收斂 | 分離創意生成與評估階段 |
| **Improv Theater Pattern** | 對話結構 | 接受並建構，而非否定 |
| **Snowball Effect** | 想法累加 | 小想法滾成大創意 |

**核心洞察**：Yes And Building 的力量不在於「肯定」本身，而在於它打破了「創意 → 批評 → 自我審查 → 創意枯竭」的惡性循環。當你知道自己的想法會被接受和擴展時，你的大腦會進入「探索模式」而非「防禦模式」。這就是為什麼即興喜劇演員能在舞台上創造出驚人的即興表演——他們的規則不是「想出好點子」，而是「接受並建構」。
