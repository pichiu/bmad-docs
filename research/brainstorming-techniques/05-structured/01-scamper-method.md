...
| 相關模式/方法論 | 連結點 | 應用價值 |
|----------------|--------|----------|
| **Osborn's Checklist** | SCAMPER的前身 | Alex Osborn的原始創意檢查清單 |
| **TRIZ Inventive Principles** | 40條發明原則 | 更系統化的技術創新方法 |
| **Morphological Analysis** | 系統性組合 | Zwicky的形態分析法 |
| **Design Thinking** | 發想階段工具 | 在ideation階段系統化產生概念 |
| **Forced Connections** | 強制連結 | 透過結構化問題強迫新連結 |

**核心洞察**：SCAMPER的天才在於把「創意」變成「問題回答」。當有人說「給我一個創意」，大腦會凍結；但當有人問「這個可以用什麼替代？」，大腦會開始搜尋。七個鏡頭不是限制創意，而是給創意七個不同的入口。最好的SCAMPER使用者不是依序回答問題的人，而是在第三個問題時突然把第一個和第五個答案結合起來的人——七個鏡頭是地圖，不是軌道。
