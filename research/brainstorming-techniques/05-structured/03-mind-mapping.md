...
| 相關模式/方法論 | 連結點 | 應用價值 |
|----------------|--------|----------|
| **Radiant Thinking (放射思考)** | 神經結構隱喻 | 模仿神經元的連接方式 |
| **Whole Brain Thinking** | 左右腦整合 | Herrmann的全腦思維模型 |
| **Concept Mapping** | Novak的概念圖 | 學術版的視覺化知識組織 |
| **Sketch Notes (視覺筆記)** | 視覺化記錄 | 結合繪圖和文字的筆記法 |
| **Cornell Notes** | 結構化筆記 | 傳統線性筆記的對比 |

**核心洞察**：心智圖的魔力不在於繪製時——而在於繪製後你能「一眼看見全局」。線性筆記把10頁內容分散在10頁紙上；心智圖把10頁內容濃縮在一張圖上。這不只是節省空間，而是改變了認知方式：你的眼睛可以在任意兩點之間跳躍，發現線性閱讀永遠發現不了的關聯。最好的心智圖不是畫得最漂亮的，而是能讓你在幾週後看到時立即喚起所有記憶的——那些「丑陋的個人塗鴉」往往比精美的模板更有效。
