...
| 模式名稱 | 應用位置 | 核心價值 |
|----------|----------|----------|
| **Inquiry-Based Learning** | 教育理論 | 學習始於好問題 |
| **Socratic Method** | 哲學傳統 | 用問題引導思考 |
| **Problem Framing** | 設計思維 | 定義正確的問題 |
| **Questions > Answers** | Warren Berger 觀點 | 美麗的問題比答案重要 |

**核心洞察**：Einstein 說過「如果我有一小時解決問題，我會花 55 分鐘定義問題」。Question Storming 體現了這個智慧：太多團隊急著找答案，卻沒有確認他們在解決正確的問題。當你有 50 個關於問題的問題時，你對問題的理解比只有一個「解決方案」時深刻得多。
