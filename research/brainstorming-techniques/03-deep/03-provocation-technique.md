...
| 模式名稱 | 應用位置 | 核心價值 |
|----------|----------|----------|
| **PO (Provocative Operation)** | de Bono 術語 | 標記這是挑釁而非陳述 |
| **Movement vs Judgment** | 思維模式 | 從挑釁移動而非評判 |
| **Stepping Stone** | 目的定位 | 挑釁是跳板，不是目的地 |
| **Escape Thinking** | 水平思考 | 逃離既有模式 |

**核心洞察**：Provocation Technique 的「PO」標記是關鍵——它告訴大腦：「這不是我的意見，這是一個思想實驗。」當你說「PO: 餐廳不收錢」時，你不是在提議免費餐廳，你是在創造一個跳板。從這個跳板，你可能跳到訂閱制、廣告贊助、或社會企業模式。荒謬本身沒有價值，它的價值在於它把你帶到哪裡。
