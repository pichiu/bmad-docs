...
| 相關模式/方法論 | 連結點 | 應用價值 |
|----------------|--------|----------|
| **Hero's Journey (Joseph Campbell)** | 英雄之旅的 12 階段 | 建構有力品牌與產品敘事的萬用框架 |
| **Archetypes (Carl Jung)** | 原型心理學 | 運用英雄、導師、陰影等角色激發共鳴 |
| **StoryBrand Framework (Donald Miller)** | 品牌故事公式 | 實用的品牌敘事 7 步驟框架 |
| **Aristotle's Narrative Structure** | 三幕劇結構 | 設定-衝突-解決的基本戲劇張力 |
| **Monomyth** | 單一神話原型 | 跨文化共通的故事模式 |

**核心洞察**：Mythic Frameworks 的力量來自人類心理的深層結構——我們天生就是「故事動物」。英雄之旅不是 Hollywood 的發明，而是跨越所有文化的普世模式。當品牌、產品、策略被放入這個框架，它們不再只是資訊，而成為能夠觸動靈魂的敘事。關鍵洞見：品牌不應該把自己當英雄，而應該成為導師——幫助用戶（真正的英雄）完成他們的轉化之旅。
