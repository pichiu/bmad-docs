...
| 模式名稱 | 應用位置 | 核心價值 |
|----------|----------|----------|
| **TRIZ Principle #13** | 整體方法 | 系統化的反轉創新原則 |
| **Assumption Surfacing** | 假設識別 | 讓隱藏假設顯現 |
| **Inverse Logic** | 思維操作 | 從相反方向審視問題 |
| **Shadow Illumination** | 洞見發現 | 反面往往照亮正面 |

**核心洞察**：反轉思維的威力在於它揭示了我們「理所當然」的假設。當你反轉「餐廳應該有固定菜單」，你會發現 omakase（主廚選菜）的可能性。當你反轉「顧客來店裡」，你會發現外送服務。這些「顯而易見」的創新，只有在我們意識到原本假設的存在後才變得可見。
