...
| 模式名稱 | 應用位置 | 核心價值 |
|----------|----------|----------|
| **Conceptual Metaphor** | Lakoff-Johnson 理論 | 隱喻塑造我們的思維方式 |
| **Domain Mapping** | 結構對應 | 源領域到目標領域的系統映射 |
| **Abstract to Concrete** | 溝通技術 | 用具體事物解釋抽象概念 |
| **Embodied Cognition** | 認知基礎 | 身體經驗是概念的基礎 |

**核心洞察**：George Lakoff 說「我們藉以生活的隱喻」——這不只是修辭學，而是認知科學。當我們說「時間是金錢」，我們會節省時間、花時間、投資時間。隱喻不只是描述現實，它塑造現實。選擇不同的隱喻，就是選擇不同的思考和行動方式。
