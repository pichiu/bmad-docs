...
| 模式名稱 | 應用位置 | 核心價值 |
|----------|----------|----------|
| **Aristotelian Method** | 哲學基礎 | 回到不可再分解的基本真理 |
| **Decomposition Pattern** | 分析方法 | 將複雜問題拆解到原子層級 |
| **Analogy vs First Principles** | 思維對比 | 超越「別人怎麼做」的限制 |
| **Elon Musk Method** | 商業應用 | 挑戰行業定價和方法的假設 |

**核心洞察**：First Principles 是最強大也最費力的創新方法。當 Elon Musk 問「電池的原材料成本是多少」而不是「電池的市場價格是多少」時，他打開了一扇別人看不到的門。這種思維需要勇氣——因為你在質疑整個行業的智慧——也需要謙遜——因為你必須承認自己不知道答案，然後從頭建構。
