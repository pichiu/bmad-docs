...
flowchart TD
    ...
    B -->|療癒童年創傷| C[Inner Child Conference]
    B -->|整合陰暗面| D[Shadow Work Mining]
    B -->|發現核心價值| E[Values Archaeology]
    B -->|規劃未來願景| F[Future Self Interview]
    B -->|連結身體智慧| G[Body Wisdom Dialogue]
    B -->|突破自我限制| H[Permission Giving]
```
