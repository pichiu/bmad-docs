...
| 相關模式/方法論 | 連結點 | 應用價值 |
|----------------|--------|----------|
| **Values Clarification (價值澄清)** | 系統化價值探索 | 1960年代的教育運動遺產 |
| **ACT (接納承諾療法)** | 價值導向生活 | 用價值引導行動而非情緒 |
| **Motivational Interviewing** | 深層動機挖掘 | 追問「為什麼」直到觸底 |
| **Laddering Technique** | 階梯式挖掘 | 從表面屬性到深層價值 |
| **Existential Psychology** | 意義追尋 | Frankl的生命意義探索 |

**核心洞察**：你宣稱的價值觀和你真正的價值觀常常不同——看看你的行事曆和銀行帳單，那裡才是真相。說「家庭最重要」但每週工作70小時的人，真正的價值可能是成就或安全感。這不是偽善，而是我們內化了太多「應該重視」的東西，掩蓋了真正驅動我們的力量。價值考古的目的不是評判，而是對齊——當你發現真正驅動你的是「被看見」而非「成功」，你就能找到更多滿足這個需求的方式，而不是死守一條「應該」的路。
